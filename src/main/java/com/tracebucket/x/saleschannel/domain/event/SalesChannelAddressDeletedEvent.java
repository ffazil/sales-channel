 ...
 */
public class SalesChannelAddressDeletedEvent implements SalesChannelEvent {
    ...
    public SalesChannelAddressDeletedEvent(String id, String name, String description, SalesChannelType channelType) {
        this.id = id;
        this.name = name;
