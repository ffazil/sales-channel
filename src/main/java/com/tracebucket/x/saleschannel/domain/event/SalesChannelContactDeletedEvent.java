 ...
 */
public class SalesChannelContactDeletedEvent implements SalesChannelEvent {
    ...
    public SalesChannelContactDeletedEvent(String id, String name, String description, SalesChannelType channelType) {
        this.id = id;
        this.name = name;
